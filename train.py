...
parser.add_argument('--dataset', default='temp.pth', help='Pretrained base model')
parser.add_argument('--batch_size', default=32, type=int, help='Batch size for training')
parser.add_argument('--resume', default='no', choices=['yes', 'no'], type=str, help='to resume the training')
...
def train(resume, file_weights):
    
    args.dataset = file_weights
    args.resume = resume
    args.batch_size = 16    
    args.num_workers = 2

    filename = args.save_folder + "/" + args.dataset
